        ...
        <div class="panel-2">
            <div class="content-2">
                ...
                <form action="change_data.php"method="post" id="content">     
                    <div id="set-1">
                        ID: <?php echo $_SESSION['borrower_id'];?>
...
if ($result->num_rows>0){
    ...
    echo '
                        First Name:
                        <input type="text" name="borrowers_fname" placeholder="'.$borrowers_fname.'"id="textbox" style="margin-left: 2rem;"><br>
                        Last Name:
                        <input type="text" name="borrowers_lname"placeholder="'.$borrowers_lname.'" id="textbox" style="margin-left: 2.1rem;"><br>
                        Address:
                        <input type="text" name="borrowers_address" placeholder="'.$borrowers_address.'"id="textbox" style="margin-left: 3.2rem;"><br>
                        Contact:
                        <input type="text" name="borrowers_contact" placeholder="'.$borrowers_contact.'"id="textbox" style="margin-left: 3.3rem;"><br>
                    </div>   
                        <div id="set-2">
                            Email:
                            <input type="email" name="borrowers_email" placeholder="'.$borrowers_email.'"id="textbox" style="margin-left: 3.2rem;"><br>
                            Gender: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            ...
                            Age:
                            <input type="text" name="borrowers_age"placeholder="'.$borrowers_age.'" id="textbox" style="margin-left: 3.8rem;"><br>
                        </div>';}
                        ?>
                        <div id="img3">
                        ...
                        <div class="toggle-buttons">                          
                            <button type="submit" name="new_borrower" id="button" value="Add" style="margin-left: -12.9rem; position: fixed;">Update</button>
