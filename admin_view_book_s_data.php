...
<head>
    ...
    <title>Admin Form  I  View Book's Data</title>
</head>
<body>
        ...
        <div class="panel-2">
            <div class="content-2">
                ...
                <form action="change_data.php" method="post" id="content">
                    Input ID: &nbsp;&nbsp;<input type="text" name="book_id" id="textbox" style="" required>
                </div>  
                <p>Book's Data View</p>
                    <div id="sign-out">
                    <a href="admin_book_s_data.php" id="sing">Back</a><i class="fa-solid fa-arrow-right-from-bracket"></i> 
                    </div>
...
if ($result->num_rows>0){
  ...
  <?php if (isset($_GET['error'])) { ?>
    <span style="color: red; font-size: 14px; margin-right:7.8rem; font-family: 'Varela Round', sans-serif;"><?php echo $_GET['error']; ?></span>
  <?php } ?>
  <?php if (isset($_GET['success'])) { ?>
    <span style="color: green; font-size: 14px; margin-right:7.8rem; font-family: 'Varela Round', sans-serif;"><?php echo $_GET['success']; ?></span>
  <?php } ?>                        
                        <input type="submit" name="update_book" id="button" value="Update" style="margin-right: 2.5rem;">
                        <input type="submit" name="delete_book" id="button" value="Delete" style="margin-right: 2.5rem;">
