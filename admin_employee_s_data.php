...
<body>
  ...
  <?php } ?>
                        <br>
                        First Name:
                        <input type="text" name="fname" id="textbox" style="margin-left: 2rem;" required><br>
                        Last Name:
                        <input type="text" name="lname" id="textbox" style="margin-left: 2.1rem;" required><br>
                        Contact:
                        <input type="text" name="contact" id="textbox" style="margin-left: 3.3rem;" required><br>
                        Privilege:
                        ...
                        <div id="set-2">
                            ...
                            Username:
                            <input type="text" name="username" id="textbox" style="margin-left: 4.4rem;"required><br>
                            Password:
                            <input type="password" name="password" id="textbox" style="margin-left: 4.6rem;"required><br>
                            Confirm Password:
                            <input type="password" name="confirm" id="textbox" style="margin-left: 1rem;"required><br>
                        </div>
                        <div id="img3">
                            <img src="Admin_File_Manager.svg" width="32%" height="32%">
                        </div>
                        <div class="toggle-buttons">                          
                            <button type="submit" name="add_employee" id="button" value="Add" style="margin-left: -12.9rem; position: fixed;">Add</button>
