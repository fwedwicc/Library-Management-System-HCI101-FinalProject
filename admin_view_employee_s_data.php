...
<head>
    ...
    <title>Admin Form  I  View Employee's Data</title>
</head>
<body>
    <div class="main-container">
        ...
        <div class="panel-2">
            <div class="content-2">
                <h1>Employee's Data</h1><br>
                <div id="in">
                    
                <form action="change_data.php" method="post" id="content">
                    Input ID: &nbsp;&nbsp;<input type="text" name="employee_id" id="textbox" style="" required>
                </div>
                <p>Employee's Data View</p>
                    <div id="sign-out">
                    <a href="admin_employee_s_data.php" id="sing">Back</a><i class="fa-solid fa-arrow-right-from-bracket"></i> 
                    </div> 
...
if ($result->num_rows>0){
    ...
    $password=$row['password'];echo '<tr><td>'.$id.'</td><td>'.$fname.'</td><td>'.$lname.'</td><td>'.$contact.'</td><td>'.$type.'</td><td>'.$username.'</td><td>'.$password.'</td><td>'.$password.'</td><tr>';
}
}?>
  ...
  <?php if (isset($_GET['error'])) { ?>
    <span style="color: red; font-size: 14px; margin-right: 6.4rem; font-family: 'Varela Round', sans-serif;"><?php echo $_GET['error']; ?></span>
  <?php } ?>
  <?php if (isset($_GET['success'])) { ?>
    <span style="color: green; font-size: 14px; margin-right: 5.4rem; font-family: 'Varela Round', sans-serif;"><?php echo $_GET['success']; ?></span>
  <?php } ?>                       
                        <input type="submit" name="update_employee" id="button" value="Update" style="margin-right: 2.5rem;">
                        <input type="submit" name="delete_employee" id="button" value="Delete" style="margin-right: 2.5rem;">
