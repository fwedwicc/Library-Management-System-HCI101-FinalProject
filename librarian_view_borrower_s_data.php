...
<head>
    ...
    <title>Librarian Form  I  View Borrower's Data</title>
</head>
<body>
        ...
        <div class="panel-2">
            <div class="content-2">
                ...
                <p>Borrower's Data View</p>
                    <div id="sign-out">
                    <a href="librarian_borrower_s_data.php" id="sing">Back</a><i class="fa-solid fa-arrow-right-from-bracket"></i> 
                    </div>
...
if ($result->num_rows>0){
  ...
  <?php if (isset($_GET['error'])) { ?>
    <span style="color: red; font-size: 14px; margin-right: 5.4rem; font-family: 'Varela Round', sans-serif;"><?php echo $_GET['error']; ?></span>
  <?php } ?>
  ...
  <?php } ?>                        
                        <input type="submit" name="lib_update_borrower" id="button" value="Update" style="margin-right: 2.5rem;">
                        <input type="submit" name="lib_delete_borrower" id="button" value="Delete" style="margin-right: 2.5rem;">
