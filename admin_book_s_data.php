...
<body>
  ...
  <?php } ?>
                        <br>
                        Book Name:
                        <input type="text" name="bname" id="textbox" style="margin-left: 2rem;"><br>
                        Book Genre:
                        <input type="text" name="bgenre" id="textbox" style="margin-left: 2rem;"><br>
                        Author:
                        <input type="text" name="bauthor" id="textbox" style="margin-left: 4rem;"><br>
                        Published Date:
                        <input type="text" name="bdate" id="textbox" style="margin-left: 0.6rem;"><br>
                    </div>   
                        <div id="set-2">
                            Publisher:
                            <input type="text" name="bpublisher" id="textbox" style="margin-left: 4.4rem;"><br>
                            Quantity:
                            <input type="number" name="bqty" id="textbox" style="margin-left: 4.7rem;"  min="1"><br>
                            Shelf Number:
                            <input type="text" name="bshelf" id="textbox" style="margin-left: 2.6rem;"><br>
                        </div>
                            <div id="img3">
                                <img src="Admin_File_Manager.svg" width="32%" height="32%">
                            </div>
                        <div class="toggle-buttons">                          
                            <button type="submit" name="add_book" id="button" value="Add" style="margin-left: -12.9rem; position: fixed;">Add</button>
