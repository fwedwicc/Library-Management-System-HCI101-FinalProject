...
<head>
    ...
    <title>Admin Form  I  Book's Data</title>
</head>
<body>
...
echo 'Book Name:
                        <input type="text" name="bname" placeholder="'.$name.'" id="textbox" style="margin-left: 2rem;"><br>
                        Book Genre:
                        <input type="text" name="bgenre" placeholder="'.$genre.'" id="textbox" style="margin-left: 2rem;"><br>
                        Author:
                        <input type="text" name="bauthor"placeholder="'.$author.'"  id="textbox" style="margin-left: 4rem;"><br>
                        Published Date:
                        <input type="text" name="bdate" placeholder="'.$published.'" id="textbox" style="margin-left: 0.6rem;"><br>
                    </div>   
                        <div id="set-2">
                            Publisher:
                            <input type="text" name="bpublisher" placeholder="'.$publisher.'" id="textbox" style="margin-left: 4.4rem;"><br>
                            Quantity:
                            <input type="number" name="bqty"placeholder="'.$quantity.'" id="textbox" style="margin-left: 4.7rem;"  min="0"><br>
                            Shelf Number:
                            <input type="text" name="bshelf"placeholder="'.$shelf.'" id="textbox" style="margin-left: 2.6rem;"><br>
                        </div>';
                        ...
                        <div class="toggle-buttons">                          
                            <button type="submit" name="new_book" id="button" value="Add" style="margin-left: -12.9rem; position: fixed;">Updatte</button>
                                <a href="admin_view_book_s_data.php" onclick="myFunction()" >
